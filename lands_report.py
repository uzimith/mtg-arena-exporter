...
LAND_CYCLES: list[dict] = [
    {
        ...
        "lands": [
            {"name": "Deserted Beach",     "jp": "見捨てられた浜辺",    "pair": "WU", "rel": "ally"},
            {"name": "Shipwreck Marsh",    "jp": "難破船の湿地",        "pair": "UB", "rel": "ally"},
            {"name": "Haunted Ridge",      "jp": "憑依された峰",        "pair": "BR", "rel": "ally"},
            {"name": "Rockfall Vale",      "jp": "岩だらけの谷間",      "pair": "RG", "rel": "ally"},
            ...
            {"name": "Deathcap Glade",     "jp": "毒々しい林間地",      "pair": "BG", "rel": "enemy"},
    ...
    },
    {
        ...
        "lands": [
            ...
            {"name": "Dragonskull Summit", "jp": "ドラゴンの頭蓋の山頂", "pair": "BR", "rel": "ally"},
    ...
    },
    {
        ...
        "lands": [
            {"name": "Seachrome Coast",     "jp": "海辺の城塞",    "pair": "WU", "rel": "ally"},
            ...
            {"name": "Inspiring Vantage",   "jp": "霊気拠点",      "pair": "RW", "rel": "enemy"},
    ...
    },
    {
        ...
        "lands": [
            ...
            {"name": "Shivan Reef",       "jp": "シヴの岩礁",       "pair": "UR", "rel": "enemy"},
    ...
    },
    {
        ...
        "mechanic": "ETBタップ＋諜報1",
        "lands": [
            {"name": "Meticulous Archive",   "jp": "几帳面な文書管理人",  "pair": "WU", "rel": "ally"},
            {"name": "Undercity Sewers",     "jp": "下町の下水道",        "pair": "UB", "rel": "ally"},
            {"name": "Raucous Theater",      "jp": "騒々しい劇場",        "pair": "BR", "rel": "ally"},
            {"name": "Commercial District",  "jp": "商業地区",            "pair": "RG", "rel": "ally"},
            {"name": "Lush Portico",         "jp": "青々とした玄関地帯",  "pair": "GW", "rel": "ally"},
            {"name": "Shadowy Backstreet",   "jp": "影の裏通り",          "pair": "WB", "rel": "enemy"},
            {"name": "Thundering Falls",     "jp": "雷鳴の滝",            "pair": "UR", "rel": "enemy"},
            {"name": "Underground Mortuary", "jp": "地下の霊廟",          "pair": "BG", "rel": "enemy"},
            {"name": "Elegant Parlor",       "jp": "優雅な談話室",        "pair": "RW", "rel": "enemy"},
            {"name": "Hedge Maze",           "jp": "生け垣の迷路",        "pair": "GU", "rel": "enemy"},
        ],
    },
    {
        ...
        "lands": [
            {"name": "Floodfarm Verge",  "jp": "洪水農場の境目", "pair": "WU", "rel": "ally"},
            {"name": "Gloomlake Verge",  "jp": "陰鬱湖の境目",   "pair": "UB", "rel": "ally"},
            {"name": "Blazemire Verge",  "jp": "炎沼の境目",     "pair": "BR", "rel": "ally"},
            {"name": "Thornspire Verge", "jp": "棘尖塔の境目",   "pair": "RG", "rel": "ally"},
            {"name": "Hushwood Verge",   "jp": "静寂林の境目",   "pair": "GW", "rel": "ally"},
            {"name": "Bleachbone Verge", "jp": "漂白骨の境目",   "pair": "WB", "rel": "enemy"},
            {"name": "Riverpyre Verge",  "jp": "河火の境目",     "pair": "UR", "rel": "enemy"},
            {"name": "Willowrush Verge", "jp": "柳疾風の境目",   "pair": "GU", "rel": "enemy"},
        ],
    },
    {
